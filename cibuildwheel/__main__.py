...
def main():
    ...
    if platform == 'linux':
        ...
        # Testing 7.3.0. Before merging PR, reset to 'pypywheels/manylinux2010-pypy_x86_64'!
        default_manylinux_images_pypy_x86_64 = {'manylinux2010': 'yannickjadoul/manylinux2010-pypy_x86_64:7.3.0'} 
