...
def test_cpp11(tmp_path):
    ...
    add_env = {'CIBW_SKIP': 'cp27-win* pp27_73-win*', 'CIBW_ENVIRONMENT': 'STANDARD=11'}
...
def test_cpp14():
    ...
    add_env = {'CIBW_SKIP': 'cp27-win* pp27_73-win* cp35-win*', 'CIBW_ENVIRONMENT': 'STANDARD=14'}
    # VC++ for Python 2.7 does not support modern standards
...
def test_cpp17():
    ...
    add_env = {'CIBW_SKIP': 'cp27-win* pp27_73-win* cp35-win*', 'CIBW_ENVIRONMENT': 'STANDARD=17'}
    if utils.platform == 'macos':
